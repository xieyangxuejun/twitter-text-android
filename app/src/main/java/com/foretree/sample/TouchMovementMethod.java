...
public class TouchMovementMethod extends BaseMovementMethod {
    ...
    public TouchMovementMethod(Context context){
        this.mTextViewBgColor = context.getResources().getColor(android.R.color.transparent);
        this.mPressSpanBgColor = context.getResources().getColor(android.R.color.transparent);
    }
